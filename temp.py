...
tomorrow = currentTime + 60 *  60 * 2


while time.time() < tomorrow:
	timeout = time.time() + 60 *20   # 15 minutes from now
	...
	data = urllib.urlopen("https://api.thingspeak.com/update?api_key=2ISBIL14XAZP4PRP&field2=" + str(fTemp));
	count = 0;
